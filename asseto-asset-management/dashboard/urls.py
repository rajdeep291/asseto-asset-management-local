...
urlpatterns = [
    ...
    path('product-sub-categories/add', product_sub_category_views.add_product_sub_category, name='add_product_sub_category'),
        path('product-categories/delete/<uuid:id>', product_sub_category_views.delete_product_sub_category, name='delete_product_sub_category'),
    path('product-categories/update/<uuid:id>', product_sub_category_views.update_product_sub_category, name='update_product_sub_category'),
    # path('product-categories/status/<uuid:id>', product_sub_category_views.product_category_status, name='product_category_status'),
    # path('product-categories/search/<str:page>', product_sub_category_views.search_product_category, name='search_product_category'),
]